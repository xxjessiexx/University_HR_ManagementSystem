<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessingAnnualLeaves.aspx.cs" Inherits="UNI.ProcessingAnnualLeaves" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Processing Annual Leave</title>
...
<body>
    ...
    <li><a href="MyDeductions.aspx">Deductions</a></li>
     ...
     <div class="page-title">Processing Annual Leaves</div>
     ...
     <div class="card">
         ...
         <asp:TextBox ID="rep_id" runat="server"></asp:TextBox>

         <asp:Button ID="btnProcessLeave" runat="server" Text="Process Leave" CssClass="btn" OnClick="approve" />
         <br />
