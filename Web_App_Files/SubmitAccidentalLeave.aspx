<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubmitAccidentalLeave.aspx.cs" Inherits="UNI.SubmitAccidentalLeave" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Submit Accidental Leave</title>
...
<body>
    ...
    <li><a href="MyDeductions.aspx">Deductions</a></li>
     ...
     <div class="page-title">Submit Accidental Leave</div>
     ...
     <div class="card">
         ...
         <asp:Button ID="btnSubmitLeave" runat="server" Text="Submit Leave" CssClass="btn" OnClick="Submit_accidental" />
         <br />
